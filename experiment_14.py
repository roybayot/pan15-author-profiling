...
"""
Experiment 14: Personality classification of English tweets based on combo of function words
...
for language, datafile in zip(languages, datafiles):
	for dimension in personality_dimensions:
		...
		print "*"*80
		print "Results for %s classification for %s." % (dimension, language)
